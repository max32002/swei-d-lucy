...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-d-lucy/raw/master/WebFont/CJK%20TC/SweiDLucyCJKtc-Regular.woff2) format("woff2")
  , url(https://github.com/max32002/swei-d-lucy/raw/master/WebFont/CJK%20TC/SweiDLucyCJKtc-Regular.woff) format("woff");
}
```
